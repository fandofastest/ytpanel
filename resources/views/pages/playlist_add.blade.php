@extends('layouts.app', ['activePage' => 'playlistadd', 'titlePage' => __('New Playlists')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('playlist.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
