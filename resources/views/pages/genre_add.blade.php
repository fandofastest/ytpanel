@extends('layouts.app', ['activePage' => 'Genretadd', 'titlePage' => __('New Genre')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data" action="{{ route('genre.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
